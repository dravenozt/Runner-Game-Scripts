...
{   
    ...
    private void Update() {
        ...
        transform.position=Vector3.SmoothDamp(transform.position,player.transform.position+ offSet.position,ref velocity,0.1f);//player.transform.position+ offSet.position;
